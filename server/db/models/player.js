...
module.exports = (sequelize, DataTypes) => {
  class Player extends Model {
     ...
     */
    static associate({ Club, City, Country, User, Team, Transaction, Coach, Item, Skin }) {
      ...
      this.hasMany(Item, { foreignKey: 'playerId', as: 'items' });
      this.hasMany(Skin, { foreignKey: 'playerId', as: 'skin'});
    }
  }
  Player.init(
    {
